 ...
 * metadata when it has any, the Fabric mods bundled inside it as nested jar-in-jars
 * (flattened, all nesting levels), and the deep contents the analysis passes inspect.
 * An empty loader set means the jar carries no known mod metadata at all.
 */
